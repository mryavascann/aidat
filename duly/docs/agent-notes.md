...
Updated September 19, 2026. This is the continuation point for the Duly MVP: rebrand, vault integration, browser app, stellar-build design adaptation and dark mode.
...
- The user fixed MVP scope: **collect contributions → approve together → follow the payment**. Dark mode is the final usability addition for this iteration. Periodic billing, expanded administration, new currencies and yield products are deferred; do not turn earlier suggestions into new feature work.
